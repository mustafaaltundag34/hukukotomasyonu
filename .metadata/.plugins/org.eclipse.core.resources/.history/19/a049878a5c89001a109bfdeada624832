...
public class siteAjandakaydiekle extends JDialog {
	...
	public siteAjandakaydiekle() {
		...
		btnkaydet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					...
					String sorgu_kaydet="insert into siteajanda(Aciklama,hatirlat,hakedis,personeladisoyadi)values('"+aciklama.getText() +"','"+tarih1 +"','"+hakedistxt.getText() +"','"+sikayetialan.getSelectedItem().toString() +"')";
		...
		btnDuzenle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					...
					String sorgu_kaydet="update siteajanda set hatirlat='"+tarih1+"',hakedis='"+hakedistxt.getText()+"',personeladisoyadi='"+sikayetialan.getSelectedItem().toString()+"',Aciklama='"+aciklama.getText() +"' where islemid='"+siteAjandaanaekrani.id_sakla+"'";
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent e) {
				...
				siteAjandaanaekrani.id_sakla=siteAjandaanaekrani.id;
				siteAjandaanaekrani.id=0;
				siteBaglanti baglan = new siteBaglanti();
				baglan.yap();
				...
				try {
					...
					String listele="Select * From siteajanda where islemid='"+siteAjandaanaekrani.id_sakla+"'";
					baglan.mystat1=baglan.myconn1.createStatement();
